        ...
        api.bulk(
            ...
            switch (bulkItemResponse.getOpType()) {
                ...
                case CREATE:
                    ...
                    @SuppressWarnings("unused") final IndexResponse indexResponse = (IndexResponse) response;
                    break;
                case UPDATE:
                    log.info("The document was updated.");
                    @SuppressWarnings("unused") final UpdateResponse updateResponse = (UpdateResponse) response;
                    break;
                case DELETE:
                    log.info("The document was deleted.");
                    @SuppressWarnings("unused") final DeleteResponse deleteResponse = (DeleteResponse) response;
                    break;
            }
        });
    }
