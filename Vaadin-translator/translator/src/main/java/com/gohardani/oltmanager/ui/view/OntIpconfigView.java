...
@Route(value = "OntIpconfig", layout = MainLayout.class)
public class OntIpconfigView extends VerticalLayout {

    public OntIpconfigView(SshService sshService, OntService ontService, OltService oltService, CommandHistoryService commandHistoryService, FrameService frameService, SlotService slotService, PortService portService, LineProfileService lineProfileService, ServiceProfileService serviceProfileService) {
