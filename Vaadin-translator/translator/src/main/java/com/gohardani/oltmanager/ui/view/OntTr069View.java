...
@Route(value = "OntTr069", layout = MainLayout.class)
public class OntTr069View extends VerticalLayout {

    public OntTr069View(SshService sshService, OntService ontService, OltService oltService, CommandHistoryService commandHistoryService, FrameService frameService, SlotService slotService, PortService portService, LineProfileService lineProfileService, ServiceProfileService serviceProfileService) {
