...
public class Lemmatizer {
    ...
    // Constructors
    //
    private static void welcome(String no){
        System.out.println("Welcome to the Lemmatizer"+no);
    }
    ...
    public Lemmatizer(String wordsFile, String verbsFile, boolean joinedVerbParts)
        ...
        List<String> pureVerbs = Files.readAllLines(Paths.get(verbsFile), StandardCharsets.UTF_8);
